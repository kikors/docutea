...
class SuccessStoreOrder implements ApplicationServiceTransformInterface
{
    /**
    ...
    public function execute($tpvResponse = null): void
    {
        ...
        $this->notifier->notify(
            ...
            new EmailSalesOrderNotificationType(NotifierActions::NOTIFY_STORE_ORDER_CREATED)
        );

        $this->notifier->notify(
            new EmailStoreOrderNotification($this->transformer->read(), 'miguel.cueva@gdoadapta.es'),
            new EmailSalesOrderNotificationType(NotifierActions::NOTIFY_STORE_ORDER_CREATED)
        );
