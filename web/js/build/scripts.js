...
/*
  ...
  $('.js-configurator-button').on('click',function(e){
    ...
    $contratarButton.on('click', function(){
        ...
        var porColor = $('#selectColor').val() == 1 ? $("input[name='ink']").val() : 0;

        console.log("=============================="+porColor);
    ...
    $("body").on("click",".machine-list__ca-button",function(event){
		...
		paginasColor = ($('#selectColor').val() == 2) ? 0 : $("input[name='ink']").val();
        ...
        $.ajax({
            ...
            .always(function() {
                $('#loadingModal').modal('hide');
				$('.configurator-price__ca').attr('disabled', false);
				$('.machine-list__ca-button').attr('disabled', false);
            });
