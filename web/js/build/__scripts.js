...
function validateDNICIFNIE(dni)
{
	var a = dni;
...
function validEmail(e) {
    ...
    console.log("email::::::::::::"+String(e).search (filter) != -1);
...
/********  DROPDOWN CONFIGURADOR ***********/


//checkDeliverydeliveryAddress
    ...
    $( ".register-btn" ).on('click',function(){
        ...
        if($('#appbundle_setore_order_name').val() == '' || $('#appbundle_setore_order_name').val().length < 4){
            $('#appbundle_setore_order_name').addClass('border-red');
            error = 1;
        }
        else{
            $('#appbundle_setore_order_name').removeClass('border-red');
        }

        if($('#appbundle_setore_order_cif').val() == '' || !validateDNICIFNIE($('#appbundle_setore_order_cif').val())){
            $('#appbundle_setore_order_cif').addClass('border-red');
            error = 1;
        }
        else{
            $('#appbundle_setore_order_cif').removeClass('border-red');
        }

        if($('#appbundle_setore_order_address').val() == '' || $('#appbundle_setore_order_address').val().length < 4){
            $('#appbundle_setore_order_address').addClass('border-red');
            error = 1;
        }
        else{
            $('#appbundle_setore_order_address').removeClass('border-red');
        }
        
        if($('#appbundle_setore_order_town').val() == ''){
            $('#appbundle_setore_order_town').addClass('border-red');
            error = 1;
        }
        else{
            $('#appbundle_setore_order_town').removeClass('border-red');
        }
        
        if($('#appbundle_setore_order_province').val() == ''){
            $('#appbundle_setore_order_province').addClass('border-red');
            error = 1;
        }
        else{
            $('#appbundle_setore_order_province').removeClass('border-red');
        }
        
        if(!$.isNumeric($('#appbundle_setore_order_cp').val())){
            $('#appbundle_setore_order_cp').addClass('border-red');
            error = 1;
        }
        else{
            $('#appbundle_setore_order_cp').removeClass('border-red');
        }
        
        if($('#appbundle_setore_order_phone').val() == '' || $('#appbundle_setore_order_phone').val().length < 4){
            $('#appbundle_setore_order_phone').addClass('border-red');
            error = 1;
        }
        else{
            $('#appbundle_setore_order_phone').removeClass('border-red');
        }
        
        if($('#appbundle_setore_order_email').val() == '' || !validEmail($('#appbundle_setore_order_email').val())){
            $('#appbundle_setore_order_email').addClass('border-red');
            error = 1;
        }
        else{
            $('#appbundle_setore_order_email').removeClass('border-red');
        }
        
        var checkLegales = $("input[name=checkLegales]:checked").length;
        
        if (checkLegales == 0) {
           $(".checkLegalesOutlet").addClass('border-red');
           error = 1;
        } else {
           $(".checkLegalesOutlet").removeClass('border-red');
        }



        if($("input[name=checkDelivery]:checked").length){

            if($('#appbundle_setore_order_deliveryAddress').val() == '' || $('#appbundle_setore_order_deliveryAddress').val().length < 4){
                $('#appbundle_setore_order_deliveryAddress').addClass('border-red');
                error = 1;
            }
            else{
                $('#appbundle_setore_order_deliveryAddress').removeClass('border-red');
            }
            
            if($('#appbundle_setore_order_deliveryProvince').val() == ''){
                $('#appbundle_setore_order_deliveryProvince').addClass('border-red');
                error = 1;
            }
            else{
                $('#appbundle_setore_order_deliveryProvince').removeClass('border-red');
            }
            
            if($('#appbundle_setore_order_deliveryTown').val() == '' || $('#appbundle_setore_order_deliveryTown').val().length < 4){
                $('#appbundle_setore_order_deliveryTown').addClass('border-red');
                error = 1;
            }
            else{
                $('#appbundle_setore_order_deliveryTown').removeClass('border-red');
            }
            
            if(!$.isNumeric($('#appbundle_setore_order_deliveryCp').val())){
                $('#appbundle_setore_order_deliveryCp').addClass('border-red');
                error = 1;
            }
            else{
                $('#appbundle_setore_order_deliveryCp').removeClass('border-red');
            }

        }
        if(error == 0){
            // enviamos el formulario
            appbundle_setore_order.submit();
        }
        else{
    ...
    $( "#checkDelivery" ).on('click',function(){
        var checked = $("input[name=checkDelivery]:checked").length;
	...
	var url = '/tienda/cart/add/' + $(this).attr('data-id') + '/' + $( "#quantity-" + $(this).attr('data-id')).val();
...
//$( ".storeProductQty" ).on('change',function(e){
$("body").on("change",".storeProductQty",function(e){
    $('#loadingModal').modal('show');
    let element = $(this);
    
    value = element.attr('id').split("-")
    let url = '/tienda/cart/update/'+value[1]+'/'+element.val();
	e.preventDefault();
	console.log(url);
	$.ajax({
		url: url,
		...
		.done(function( data ) {
            ...
            jsonObj = data.cartProducts;
            var cadHTML = '';

            if(jsonObj.length > 0){
                for (var i=0;i<jsonObj.length;i++){
                    valores = jQuery.parseJSON(jsonObj[i]);
                    //$.each( valores, function( key, val ) {


                        cadHTML += '<div class="row">';
                        cadHTML += '    <div class="col-md-12 col-xs-12">';
                        cadHTML += '        <div class="machine-list__name-name">'+ valores.nombre +'</div>';
                        cadHTML += '    </div>';
                        cadHTML += '</div>';


                        cadHTML += '<div class="row">';
                        cadHTML += '    <div class="col-md-5 col-xs-12">';
                        cadHTML += '        <div class="machine-features">';
                        cadHTML += '            <p>'+valores.description+'</p>';
                        cadHTML += '            <ul class="iconic-list list-inline mT20 mB20">';
                        cadHTML += '                <li><img src="/images/icon-movil.png" title="" data-toggle="tooltip" data-placement="top" data-original-title="Impresión móvil"></li>';
                        cadHTML += '                <li><img src="/images/icon-wifi.png" title="" data-toggle="tooltip" data-placement="top" data-original-title="Conectividad Wi-Fi"></li>';
                        cadHTML += '                <li><img src="/images/icon-ethernet.png" title="" data-toggle="tooltip" data-placement="top" data-original-title="Conectividad Ethernet"></li>';
                        cadHTML += '                <li><img src="/images/icon-doble-cara.png" title="" data-toggle="tooltip" data-placement="top" data-original-title="Doble cara automático"></li>';
                        cadHTML += '                <li class="pull-right"><a href="5da5a15bb0536711728121.pdf" target="_blank"><img src="/images/icon-pdf.png" title="" data-toggle="tooltip" data-placement="top" data-original-title="Descargar especificaciones técnicas"></a></li>';
                        cadHTML += '            </ul>';
                        cadHTML += '        </div>';
                        cadHTML += '    </div>';
                        cadHTML += '    <div class="col-md-2 col-xs-12">';
                        cadHTML += '        <img src="/uploads/'+valores.imagePerspective+'" alt="Brother MFCL9570CDW" class="img-thumbnail my-4">';
                        cadHTML += '    </div>';
                        cadHTML += '    <div class="col-md-5 col-xs-12">';
                        cadHTML += '        <div class="price-outlet-checkout">';
                        cadHTML += '            <div class="title-outlet-checkout">Precio: ' + valores.total + ' € IVA incl.<br><span>' + valores.totalPrice +  '€ Sin IVA.</span></div>';
                        cadHTML += '            <div class="outlet-price-total-checkout">';
                        cadHTML += '                <div class="row">';
                        cadHTML += '                    <div class="col-xs-3 col-md-6">';
                        cadHTML += '                        <div class="select-quantity">Cantidad: ';
                        cadHTML += '                            <select class="select-quantity-outlet-checkout storeProductQty" name="quantity" id="quantity-2">';
                        for(k=1;k<=10;k++){
                            if(valores.quantity == k){
                                cadHTML += '<option value="'+k+'" selected>'+k+'</option>';
                            }
                            else{
                                cadHTML += '<option value="'+k+'">'+k+'</option>';
                            }
                        ...
                        cadHTML += '                </div>';
                        cadHTML += '            </div>';
                        cadHTML += '            <input type="hidden" id="productId-' + valores.id + '" value="'+valores.id+'">';
                        cadHTML += '            <button class="deletecart" value="'+valores.id+'">Eliminar</button>';
                        cadHTML += '        </div>';
                        cadHTML += '    </div>';
                        cadHTML += '</div>';
                        cadHTML += '<hr>';
            ...
            resumen = 'Total '+ data.totalQuantity +' productos:<br><br><div style="text-align:right">'+ data.totalPrice +' € <span>IVA incl.</span><br>' + 
            data.price +' € <span>Sin IVA.</span></div>';

            $('.machine-list').html(cadHTML);
            $('.title-outlet-total').html(resumen);
            $('.items-carro').html(data.totalQuantity);
                ...
                if(data.totalPrice > 0){
                    for (var i=0;i<jsonObj.length;i++){
                        ...
                        //$.each( valores, function( key, val ) {
                            ...
                            cadHTML += '                <li class="pull-right"><a href="5da5a15bb0536711728121.pdf" target="_blank"><img src="/images/icon-pdf.png" title="" data-toggle="tooltip" data-placement="top" data-original-title="Descargar especificaciones técnicas"></a></li>';
                            cadHTML += '            </ul>';
                            cadHTML += '            <a href="/tienda/product-details/' + valores.id + '" class="mT20"> Ver detalles &gt;&gt;</a>';
                            cadHTML += '        </div>';
                            cadHTML += '    </div>';
                            cadHTML += '    <div class="col-md-2 col-xs-12">';
                            cadHTML += '        <img src="/uploads/'+valores.imagePerspective+'" alt="Brother MFCL9570CDW" class="img-thumbnail my-4">';
                            ...
                            cadHTML += '    <div class="col-md-5 col-xs-12">';
                            cadHTML += '        <div class="price-outlet-checkout">';
                            cadHTML += '            <div class="title-outlet-checkout">Precio: ' + valores.price * valores.quantity + ' €</div>';
                            cadHTML += '            <div class="outlet-price-total-checkout">';
                            cadHTML += '                <div class="row">';
                            cadHTML += '                    <div class="col-xs-3 col-md-6">';
                            cadHTML += '                        <div class="select-quantity">Cantidad: ';
                    ...
                    cadHTML += '<div class="row">';
                    cadHTML += '    <div class="col-md-12 col-xs-12">';
                    cadHTML += '        <div class="machine-list__name-name">El carro está vacío</div>';
                    cadHTML += '    </div>';
                    cadHTML += '</div>';
                }
    
                /*["{\"id\":1,\"quantity\":3,\"total\":1035,\"cod\":\"HLL5100DN\",\"nombre\":\"Brother HLL5100DN\",\"description\":\"Dise\\u00f1ada para las peque\\u00f1as y medianas empresas que requieren equipos modernos, eficientes y econ\\u00f3micos para sus grupos de trabajo.\",\"price\":345,\"imagePerspective\":\"5da5a20a25c99666378786.png\",\"imageFront\":\"5da5a209c1c51274936340.png\",\"imageLateras\":\"5da5a20a22f37554887659.png\",\"sheet\":\"\",\"airPrint\":true,\"wifi\":true,\"cloud\":true,\"nfc\":true}"]}*/
    
                
                $('.machine-list').html(cadHTML);
                $('.title-outlet-total').html('Total:<br>'+ data.totalQuantity +' productos: ' + data.totalPrice + '€');
                $('.items-carro').html(data.totalQuantity);                
                
                
                /*console.log( data.productQtty );
				$.each( data, function( key, val ) {
					if (key === "productQtty") {
						$('#qtty_products').html(val);
					} else {
						$('#shopping-cart-details').html(val);
					}
				});*/
...
/*
    $('#volumenControl').on('click',function(e){
        $( ".configcolorControl" ).removeClass('hide');
    });*/

    $( ".configcolorControl" ).mouseleave(function() {
        $( ".configcolorControl" ).addClass('hide');
        $('.volumen').toggleClass("down", false);
    });

    $(".icon_filters").click(function(){
        $( ".icon_filters" ).slideUp( "slow", function() {
            // Animation complete.
            $( ".filtersform" ).slideDown("slow");
        });
    });


    $(".filtersconf").click(function(){

        if($(this).next('i').hasClass("down")){
            $(this).next('i').toggleClass("down", false);
        }
        else{
    ...
    $(".filtersconfDiv").click(function(){

        console.log('/////////////'+$(this).next('i').hasClass("down"));
        if($(this).next('i').hasClass("down")){
            $(this).next('i').toggleClass("down", false);
            //configcolorControl show
            //show
            console.log("-------------------------");
            $('.configcolorControl').addClass('hide');
    ...
    $('#selectColor').on('change',function(e){
        if($(this).val() == 1){
            $('#configuratio-round').css('display', 'block');
        }
        else{
            $('#configuratio-round').css('display', 'none');
        }
    });
  ...
  $('.js-configurator-button').on('click',function(e){
    ...
    $('.js-validate-form').validate({
        ...
        submitHandler: function (form) {
            ...
            var checkLegales = $("input[name=checkLegalesConf]:checked").length;
            if (checkLegales == 0) {
                alert("Tienes que aceptar las bases legales");
            } else {
                $('#loadingModal').modal('show');
                $.ajax({
                    url: "/user/new",
    ...
    $("#selectColor").on("click", function(event){
        ...
        if($("#selectColor").val() == 2){
            $("input[name='ink']").val(0);
        }
        else{
            $("input[name='ink']").val(15);
        }
    	
        $('.configcolorControl').addClass('hide');
    });

    $("#selectFuncion").on("click", function(event){
        $('.configcolorControl').addClass('hide');
    });

    $("#selectTamano").on("click", function(event){
        $('.configcolorControl').addClass('hide');
    });

    $("#selectTiempo").on("click", function(event){
        $('.configcolorControl').addClass('hide');
    });
    ...
    var $configuratorList = $('#machine-list-recomended .machine-list');

    //var $configuratorListTemplate = $configuratorList.find('.machine-list__item').first();


    $("body").on("click",".machine-list__ca-button",function(event){
    ...
    $('.machine-list__ca-button'). on('click', function() {
        /*var url = '/configurer/update-list'+
    ...
    $('.js-apply-filter-new'). on('click', function() {


        $( ".filtersform" ).toggle( "slow", function() {
            // Animation complete.
            $( ".icon_filters" ).slideDown();
        });
        var url = '/configurer/update'+
            ...
            '/'+$('#selectTiempo').val()+
            '/'+$("input[name='ink']").val();
        $('.js-apply-filter-new').attr('disabled', true);
        $('#loadingModal').modal('show');
        console.log(url);
            $.ajax({
                url: url,
            ...
            $('.js-apply-filter-new').attr('disabled', false);
    });
    ...
    function buildCofigurerRecomended(data) {
        ...
        $('#funcion').find('.configurator-panel__item').removeClass('selected').filter("[data-id='"+recomended.funcion+"']").addClass('selected');
        defaultValues.funcion = recomended.funcion;

        $('#color').attr("data-default",recomended.chromaType);
        $('#color').find('.configurator-panel__item').removeClass('selected')
        ...
        $('#tamano').find('.configurator-panel__item').removeClass('selected').filter("[data-id='"+recomended.format+"']").addClass('selected');
        ...
        if(recomended.airPrint){
            list += '<li>'+
                '<img src="/images/icon-doble-cara.png" title="Doble cara automático" data-toggle="tooltip" data-placement="top">'+
        ...
        if(recomended.wifi) {
            list += '<li>'+
                '<img src="/images/icon-wifi.png" title="Conectividad Wi-Fi" data-toggle="tooltip" data-placement="top">'+
                // '<div>Wifi</div>'+
                '</li>';
        }
        ...
        if(recomended.cloud) {
            list += '<li>'+
                '<img src="/images/icon-ethernet.png" title="Conectividad Ethernet" data-toggle="tooltip" data-placement="top">'+
                // '<div>Cloud</div>'+
                '</li>';
        }
        ...
        if(recomended.nfc) {
            list += '<li>'+
                '<img src="/images/icon-movil.png" title="Impresión móvil" data-toggle="tooltip" data-placement="top">'+
                // '<div>NFC</div>'+
                '</li>';
        }
        ...
        if(recomended.sheet) {
            list += '<li>'+
                ...
                '<img src="/images/icon-pdf.png" title="Descargar especificaciones técnicas" data-toggle="tooltip" data-placement="top">'+
    ...
    function buildCofigurerList(data) {
        ...
        $.each(data.machineList, function(index , value) {
            if(value.id !== recomended.id) {
                ...
                machines += '<div class="machine-list">';
                
                machines += '    <div class="row">';
                machines += '       <div class="col-md-6">';
                machines += '           <div class="machine-list__name-name">' + value.description + '</div>';
                machines += '       </div>';
                machines += '       <div class="col-md-6">';
                machines += '         <div class="machine-list__name-text">Opción ' + optionMachine + '</div>';
                machines += '       </div>';
                machines += '    </div>';
                
                
                machines += '    <div class="row">';
                machines += '    <div class="col-md-3">';
                machines += '        <div class="machine-features">';
                machines += '            <ul class="iconic-list list-inline">';
                if(value.airPrint){
                    machines += '                <li>';
                    machines += '                    <img src="/images/icon-movil.png" title="Impresión móvil" data-toggle="tooltip" data-placement="top">';
                    machines += '                </li>';
                }
                if(value.wifi) {
                    machines += '                <li>';
                    machines += '                    <img src="/images/icon-wifi.png" title="Conectividad Wi-Fi" data-toggle="tooltip" data-placement="top">';
                    machines += '                </li>';
                }
                if(value.cloud) {
                    machines += '                <li>';
                    machines += '                    <img src="/images/icon-ethernet.png" title="Conectividad Ethernet" data-toggle="tooltip" data-placement="top">';
                    machines += '                </li>';
                }
                if(value.nfc) {
                    machines += '                <li>';
                    machines += '                    <img src="/images/icon-doble-cara.png" title="Doble cara automático" data-toggle="tooltip" data-placement="top">';
                    machines += '                </li>';
                }
                if(value.sheet) {
                    machines += '                <li class="pull-right">';
                    machines += '                    <a href="'+data.pdfroute+value.sheet+'" target="_blank">';
                    machines += '                        <img src="/images/icon-pdf.png" title="Descargar especificaciones técnicas" data-toggle="tooltip" data-placement="top">';
                    machines += '                    </a>';
                    machines += '                </li>';
                }
                machines += '            </ul>';
                machines += '        </div>';
                machines += '        <div class="machine-list-page-price-bn">';
                machines += '            <span class="machine-list__price-text">Coste por pag. b&amp;n</span>';
                machines += '            <span class="machine-list__price-price">'+ prices[value.id].costByBlackPage.toFixed(5) +' €</span>';
                machines += '        </div>';
                machines += '        <div class="machine-list-page-price-color">';
                machines += '            <span class="machine-list__price-text">Coste por pag. color</span>';
                machines += '            <span class="machine-list__price-price">'+ prices[value.id].costByColorPage.toFixed(5) +' €</span>';
                machines += '        </div>';
                machines += '    </div>';
                machines += '    <div class="col-md-3">';
                machines += '        <div class="machine-list__picture">';
                machines += '            <div class="machine-list__picture-inner">';
                machines += '                <img src="/uploads/'+ value.imageFront +'">';
                machines += '            </div>';
                machines += '        </div>';
                machines += '    </div>';
                machines += '    <div class="col-md-3">';
                machines += '        <div class="machine-list__price">';
                machines += '            <div class="machine-list-fixed-price">';
                machines += '                <span class="machine-list__price-text">Precio Fijo</span>';
                machines += '                <span class="machine-list__price-price">'+ prices[value.id].fixedPrice.toFixed(2) +' €</span>';
                machines += '            </div>';
                machines += '            <div class="machine-list-variable-price">';
                machines += '                <span class="machine-list__price-text">Precio Variable</span>';
                machines += '                <span class="machine-list__price-price">'+ prices[value.id].variablePrice.toFixed(2) +' €</span>';
                machines += '            </div>';
                machines += '            <div class="machine-list__price-total">';
                machines += '                <div class="machine-list-total-price">';
                machines += '                    <span class="machine-list__price-text">Total</span>';
                machines += '                    <span class="machine-list__price-price">'+ prices[value.id].totalPrice.toFixed(2) +' €</span>';
                machines += '                </div>';
                machines += '            </div>';
                machines += '        </div>';
                machines += '    </div>';
                machines += '    <div class="col-md-3">';
                machines += '        <div class="machine-list__ca">';
                machines += '           <button class="button machine-list__ca-button" id="machine-list__ca-button" data-id="'+value.id+'">seleccionar</button>';
                machines += '        </div>';
                machines += '    </div>';
                machines += '   </div>';
                machines += '</div>';
            ...
            $('#machine-list-recomended').html(machines);
